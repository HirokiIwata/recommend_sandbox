      ...
      let recommend_exhibits = [
        {
          id: 517,
          exhibit: "地球",
          src: require("../static/A517-photo.jpg"),
          overview: "この展示室の外周は北側入口から右回りに、地球から宇宙の果てまでの天体や事象を並べています。そのスケールは、長さを10倍ずつ大きくしていくパワーズオブテン（10のべき乗）の考え方に沿っています。 その出発点は「地球」。大型スクリーンでの地球や月の映像、磁気圏とオーロラ、隕石の種類と起源、流星を展示しています。"
        }
      ]
