        ...
        <v-layout row wrap justify-center class="my-5">
          <v-flex xs12 sm4>
            <v-card flat class="transparent">
              ...
              <v-card-text>
                インターネットに代表される情報通信ネットワークにおける新技術の調査研究と、
                それらがもたらす新しい社会の在り方について教育、文化、経済など多方面から調査研究を行っています。
              </v-card-text>
            </v-card>
          </v-flex>
        </v-layout>
