...
export default {
  ...
  methods: {
    show_result: function(event){
      ...
      let a516 = {id: 516,exhibit: "パワーズオブテン",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A516.pdf",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A529.pdf",point: 0, pmi: 0,basis: [],src: require("../static/A516-photo.jpg"),overview: "この展示室の外周は北側入口から右回りに、地球から宇宙の果てまでの天体や事象を並べています。そのスケールは、長さを10倍ずつ大きくしていくパワーズオブテン（10のべき乗）の考え方に沿っています。 北側展示室入り口から時計回りに外周を回って、宇宙のスケールの旅にご出発ください。"}
      let a517 = {id: 517,exhibit: "地球",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A517.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A517-photo.jpg"),overview: "この展示室の外周は北側入口から右回りに、地球から宇宙の果てまでの天体や事象を並べています。そのスケールは、長さを10倍ずつ大きくしていくパワーズオブテン（10のべき乗）の考え方に沿っています。 その出発点は「地球」。大型スクリーンでの地球や月の映像、磁気圏とオーロラ、隕石の種類と起源、流星を展示しています。"}
      let a518 = {id: 518,exhibit: "月の満ち欠け",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A518.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A518-photo.jpg"),overview: "月は地球の周りを公転する唯一の衛星です。夜空を明るく照らすその姿は、私たちにとってとても貴重なもので、周期的な満ち欠けの様子から、暦の基準となるなど、とても身近な存在でした。月は、太陽の光に照らされているので、月全体の半分がつねに明るくなっています。さらに、月は地球のまわりを公転しているので、月をどの方向から見るかによって形が変わっていくように見えます。新月から上弦の月、満月、下弦の月と少しずつ形を変えながら、ほぼひと月（約29.5日）でもとの姿に戻ります。 この展示では月周回衛星「かぐや」のデータに基づいた回転月球儀と、それに連動した地球と月の模型で、月の満ち欠けを紹介します。"}
      let a519 = {id: 519,exhibit: "月への挑戦",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A519.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A519-photo.jpg"),overview: "サターンV型ロケットは、アポロ計画で使用された液体燃料多段式ロケットです。1968年から1973年までの6年間で合計13機が打ち上げられました。アポロ宇宙船の爆発事故によって月に着陸できなかったアポロ13号を含めて、打ち上げはすべて成功しました。全高、総重量、ペイロード（搭載物重量）などの点において、それまでに作られた、いかなるロケットよりも巨大で強力なものでした。 人類が月に第一歩を記し、各国が競って月に探査機を送るようになった21世紀まで、サターンV型ロケットの模型を中心に、月への挑戦の歴史を紹介します。"}
      let a520 = {id: 520,exhibit: "太陽系",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A520.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A520-photo.jpg"),overview: "この展示室外周は北側入口から右回りに、地球から宇宙の果てまでの天体や事象を並べています。そのスケールは、長さを10倍ずつ大きくしていくパワーズオブテン（10のべき乗）の考え方に沿っています。 地球の次の世界は太陽系。大型スクリーンでの惑星や衛星、小惑星や彗星などの太陽系天体の映像、惑星の動きと重力、惑星探査体験、小惑星や彗星、太陽系外縁天体や惑星の種類などを展示しています。"}
      let a521 = {id: 521,exhibit: "惑星の動きと引力",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A521.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A521-photo.jpg"),overview: "地球や火星などの惑星が、太陽の回りをどのように動いているのかを教えてくれるのがこの展示品です。中心の穴が太陽であり、打ち出されて回るボールが惑星です。中心に近づくほど動きが速く、遠くになるほどゆっくりになります。 惑星の動きを支配する法則は、17世紀初めにドイツの天文学者であるケプラーが発見しました。 この展示物は旧天文館から移設し、外装を改装しました。内部の曲面およびメカニズムはすべて以前からのものをオーバーホールして使っています。"}
      let a522 = {id: 522,exhibit: "惑星探査",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A522.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A522-photo.jpg"),overview: "人類初の人工衛星スプートニク１号が打ち上げられたのが、1957年。それ以降、数多くの人工衛星が打ち上げられ、地球の重力圏を離れる惑星探査機が太陽系の惑星や、小惑星や彗星を探査しました。地球からは遠すぎて見られない惑星表面の様子も、探査機で近くから見れば、表面の様子が詳しく分かります。また、探査機の運動の変化を観測することで、惑星の重力の強さなどの惑星内部の様子も知ることができます。さらに地表に着陸し、そこにある岩石を調べ、その星の成り立ちなどを知る手がかりを得ることができます。 この展示では対象天体ごとの惑星探査の歴史と、探査車の実体験展示で、惑星探査の歴史や方法、難しさなどを紹介します。"}
      let a523 = {id: 523,exhibit: "宇宙を測る・宇宙を探る",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A523.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A523-photo.jpg"),overview: "この展示室外周は北側入口から右回りに、地球から宇宙の果てまでの天体や事象を並べています。そのスケールは、長さを10倍ずつ大きくしていくパワーズオブテン（10のべき乗）の考え方に沿っています。 その目盛りや展示パネルなどに出てくる宇宙での長さの単位や、距離の測り方をまとめました。さらに、太陽系以外の惑星系や、地球外知的生命探査を紹介しています。"}
      let a524 = {id: 524,exhibit: "星座を形づくる星々",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A524.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A524-photo.jpg"),overview: "展示室のあちこちに輝く星が吊り下がっているのにお気づきでしょうか？　これは、「北斗七星」、「カシオペア座」、「オリオン座」、「夏の大三角」を形作っている恒星です。しかし下から見上げただけでは、その並びには見えません。 天文展示室の4箇所に、それぞれの対象を観察するための丸い覗き口（スコープ）が立ててあります。このスコープから眺めると、太陽系から見るのと同じ位置関係で見ることになり、それぞれの並びになって見えてきます。 この展示では、星座を形作っている星々が、見る位置や方向によって並びが変わってしまうことや、同じように見えている星でも実際の距離がずいぶん違うことを紹介します。"}
      let a525 = {id: 525,exhibit: "星の世界",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A525.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A525-photo.jpg"),overview: "この展示室外周は北側入口から右回りに、地球から宇宙の果てまでの天体や事象を並べています。そのスケールは、長さを10倍ずつ大きくしていくパワーズオブテン（10のべき乗）の考え方に沿っています。 地球、太陽系の次の世界は星の世界。大型スクリーンでの星雲や星団の映像、展示室中央から見る星座を形づくる星々。そして星の大きさ、温度や色、明るさ、連星と変光星、星の一生、星雲や星団、そしてブラックホールまで星々の世界を紹介します。"}
      let a526 = {id: 526,exhibit: "銀河の世界",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A526.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A526-photo.jpg"),overview: "この展示室外周は北側入口から右回りに、地球から宇宙の果てまでの天体や事象を並べています。そのスケールは、長さを10倍ずつ大きくしていくパワーズオブテン（10のべき乗）の考え方に沿っています。 地球、太陽系、星の次の世界は銀河。大型スクリーンでの天の川やさまざまな銀河の映像や、銀河系と天の川、銀河の種類、渦巻銀河の回転、活動銀河核、アンドロメダ銀河、局所銀河群、銀河群と銀河団などを展示しています。"}
      let a527 = {id: 527,exhibit: "銀河系と天の川",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A527.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A527-photo.jpg"),overview: "私たちの太陽系は銀河系と呼ばれる星の大集団に含まれています。銀河系にはおよそ２千億個の恒星と星間ガスが扁平な円盤状に分布しています。太陽はこの円盤内の外側に近いところに位置しているため、円盤面と垂直な方向は星がまばらになり、円盤の方向は多くの恒星が積み重なって、淡い光の帯として観測されます。これが天の川です。 この展示では、大きなアクリルの塊の中に、たくさんの気泡を入れて、立体的な銀河系の形を作ります。さらにそれを太陽系の位置で輪切りにして、外形だけではなく断面も見ることができるようにし、銀河系と天の川の関係を紹介します。"}
      let a528 = {id: 528,exhibit: "宇宙の果て",url: "http://www.ncsm.city.nagoya.jp/exhibit_files/pdf/A528.pdf",point: 0,pmi: 0,basis: [],src: require("../static/A528-photo.jpg"),overview: "この展示室外周は北側入口から右回りに、地球から宇宙の果てまでの天体や事象を並べています。そのスケールは、長さを10倍ずつ大きくしていくパワーズオブテン（10のべき乗）の考え方に沿っています。 地球、太陽系、星、そして銀河の次の世界は宇宙の果てです。大型スクリーンで宇宙の大規模構造やビッグバンから現在までの宇宙の歴史、膨張する宇宙、宇宙の地図つくり、宇宙のはじまりなどを展示しています。"}
